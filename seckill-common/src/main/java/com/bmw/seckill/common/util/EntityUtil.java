...
public class EntityUtil {
    ...
    private final String moduleName = "seckill"; // 数据库名称

    private final String bean_path = "F:\\学习\\22 stu\\实训\\项目相关\\product\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "F:\\学习\\22 stu\\实训\\项目相关\\product\\seckill-parent\\seckill-service\\src\\main\\java\\com\\bmw\\seckill\\dao";

    private final String xml_path = "F:\\学习\\22 stu\\实训\\项目相关\\product\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径
    ...
    private final String password = "04160071";// "root";//数据库密码

    private final String url = "jdbc:mysql://127.0.0.1:3306/" + moduleName + "?useSSL=false&charset=utf8mb4&serverTimezone=Hongkong";
